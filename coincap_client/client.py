from coincap_client.models.exchange_coin_to_currency import ExchangeCoinToCurrency, ExchangeCoinToCurrencyData, exchange_coin_to_currency_from_dict
...
class CoinCapClient:
    ...
    async def get_info_for_exchange(self, baseSymbol: str, quoteSymbol: str) -> ExchangeCoinToCurrencyData:
        params = [
